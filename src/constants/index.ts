...
export const vipToursCardsInfo = [
  ...
  },
  {
    ...
    order: '',
    description: {
      info: `Hyundai Starex отлично подойдет для групп до 7 человек`,
      marshrut: [],
      dopUslugi: [],
      time: `ежедневно`,
    },
  ...
  },
  {
    ...
    order: '',
    description: {
      info: `Mercedes-Benz Sprinter для групп до 20 человек`,
      marshrut: [],
      dopUslugi: [],
      time: `ежедневно`,
    },
  ...
  },
  {
    ...
    order: '',
    description: {
      info: `Mercedes-Benz V-class повышенной комфортности`,
      marshrut: [],
      dopUslugi: [],
      time: `ежедневно`,
    },
...
export const reviewsCardsInfo = [
  {
    ...
    description: 'We just got back to the hotel from a great day out! Many thanks for the last minute organisation! We had a lovely time and Ivan was amazing 😊',
    timeTag: '4 июня 2024',
    stars: 5,
  },
  {
    ...
    name: 'Имя скрыто',
    title: 'Thank You!',
    description: 'Добрый день! Спасибо вам огромное за организацию, встречу и опытного водителя ❤️🚍 я всё переживала, что приедет на автобусе ехать Работаете ответственно, добросовестно, качественно, а не на количество клиентов! 🥰',
    timeTag: '20 мая 2024',
    stars: 5,
  },
  {
    ...
    name: 'marina1.2018',
    title: 'Спасибо!',
    description: 'СПАСИБО ОТ ВСЕЙ НАШЕЙ СЕМЬИ ЗА ВАШЕ ВНИМАНИЕ, СЕРВИС ИНТЕРЕСНЫЕ ЭКСКУРСИИ. МОЛОДЦЫ РЕБЯТА! ВСЕМ РЕКОМЕНДУЕМ!!!',
  ...
  },
  {
    ...
    description: 'Наталья, спасибо за организацию нашего отдыха! Все было великолепно, начиная со встречи в аэропорту. Все экскурсии очень интересные, были организованы с учетом наших интересов. Мы, взрослые и дети, в восторге. Спасибо за индивидуальный подход! До новых встреч! ❤️',
    timeTag: '3 июля 2024',
    stars: 5,
  },
  {
    ...
    description: 'Супер тур-лучший водитель! Мы под впечатлением до сих пор. Спасибо',
    timeTag: '29 мая 2024',
    stars: 5,
  },
  {
    ...
    description: 'Очень довольны встречей! Чистый и комфортный автомобиль, с кондиционером! Очень приятный и вежливый водитель 😊',
  ...
  },
  {
    ...
    description: 'Доброе утро 💋 Мы очень устали, поэтому не писали 🙈 Нам очень всё понравилось, насыщенно, познавательно😊 Даже не обращали внимание на то, что укачивало🔥🔥🔥 Индивидуальных экскурсиях это вообще супер🔥🔥🔥🔥 Вы молодцы, что организовали нам это, остались довольны 👏💯',
  ...
  },
  {
    ...
    description: 'Добрый вечер, да все супер понравилось! Мы и на качелях покатались)) Экскурсовод у вас тоже супер! Спасибо за впечатления! 🙌🌄',
