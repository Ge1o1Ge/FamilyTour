...
export const excursCardsInfo = [
  {
    ...
    description: {
      ...
      dopUslugi: [`Подьем на канатной дороге на выбор: Роза Хутор, Красная Поляна, Аквапарк
      Галактика (3 часа)`],
      time: `пн-вс`,
    },
    img: [redFlat],
  ...
  },
  {
    ...
    description: {
      ...
      квадроциклом и багги допускаются только мужчины старше 18 лет. Один квадроцикл – 2 человека.
  ...
  },
  {
    ...
    description: {
      ...
      marshrut: [],
      dopUslugi: [
        `По желанию можно заказать вино, чачу, шашлык и рыбу.`,
      ],
      time: `ежедневно`,
    },
    img: [rafting],
  ...
  },
  {
    ...
    description: {
      ...
      dopUslugi: [
        `Экологический сбор на Рицу включен в стоимость экскурсии`,
      ],
      time: `ежедневно`,
    },
  ...
  },
  {
    ...
    order: '',
    description: {
      info: `Ресторан Гагрипш, Новый Афон, Новоафонский водопад, Новоафонский мужской монастырь Симона Канонита, Г. Сухум - набережная Махаджиров, Фонтан с грифонами, Термальный источник Кындыг`,
      marshrut: [],
      dopUslugi: [],
      time: `среда, суббота`,
    },
  ...
  },
  {
    ...
    order: '',
    description: {
      info: `Смотровая г. Гагра, Гагрипш ресторан, Колоннада, Бзыбское ущелье, Подвесной мост над рекой Бзыбь, Чабгарзский карниз, Водопад мужские слезы, Озеро Рица, Пицунда (купание в море – 2 часа)`,
      marshrut: [],
      dopUslugi: [],
      time: `ежедневно`,
    },
  ...
  },
  {
    ...
    order: '',
    description: {
      info: `Увлекательная программа 3 в 1: сорокоминутное шоу, Сочинский Дельфинарий, Океанариум, Пингвинариум.`,
      marshrut: [],
      dopUslugi: [],
...
export const vipToursCardsInfo = [
  ...
  {
    id: 9,
    name: 'VIP тур в Абхазию на минивене',
    order: '',
    description: {
